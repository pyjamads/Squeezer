...
{
    public class GameFeelCollisionScript : GameFeelBehaviorBase<OnCollisionTrigger>
    {
        ...
        {
            isTag = new List<bool>();
            foreach (var str in Trigger.ReactTo)
            {
            ...
            GameFeelTriggerData collisionData)
        {
            ...
            if (Trigger.ReactTo.Count != isTag.Count)
            {
            ...
            switch (activationType)
            {
                case OnCollisionTrigger.CollisionActivationType.OnCollisionEnter when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnCollisionEnter ||
                ...
                case OnCollisionTrigger.CollisionActivationType.OnCollisionExit when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnCollisionExit ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllExit:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnCollisionStay when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnCollisionStay ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllStay:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnCollisionEnter2D when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnCollisionEnter2D ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllEnter:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnCollisionExit2D when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnCollisionExit2D ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllExit:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnCollisionStay2D when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnCollisionStay2D ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllStay:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnTriggerEnter when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnTriggerEnter ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllEnter:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnTriggerExit when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnTriggerExit ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllExit:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnTriggerStay when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnTriggerStay ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllStay:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnTriggerEnter2D when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnTriggerEnter2D ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllEnter:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnTriggerExit2D when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnTriggerExit2D ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllExit:
                    
                    break;
                case OnCollisionTrigger.CollisionActivationType.OnTriggerStay2D when  
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnTriggerStay2D ||
                    Trigger.type == OnCollisionTrigger.CollisionActivationType.OnAllStay:
            ...
            var shouldHandleEffect = Trigger.ReactTo.Any(item => item.Contains("!"));
            for (var index = 0; index < Trigger.ReactTo.Count; index++)
            {
                var reactTo = Trigger.ReactTo[index];
